<?php
  ...
  $sanitizedSearchTerm = filter_var($searchTerm, FILTER_SANITIZE_STRING);
  ...
  $superheroes = [
   ...
   foreach ($superheroes as $superhero) 
   {
        ...
        if (stripos($superhero['name'], $sanitizedSearchTerm) !== false || stripos($superhero['alias'], $sanitizedSearchTerm) !== false) 
        {
